...
import {
    ...
    Message,
    RemainDownloadCountResultMessage,
    reportError
} from "~lib/helper";
    ...
    try {
        ...
        switch (data.type) {
            ...
            case "GetAuthorization": {
                ...
                window.postMessage(
                    new AuthorizationResultMessage(res.code === 1, res.data),
                    "*"
                );
                break;
            }
            ...
            case "GetRemainDownloadCount": {
                ...
                window.postMessage(
                    new RemainDownloadCountResultMessage(
                        res.code === 1 ? res.data.resCount : 1,
                        res.data.reason
                    ),
                    "*"
                );
